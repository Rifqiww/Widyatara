...
export default function KalimantanOnboarding() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      Object.values(modelsRef.current).forEach((model) => {
        ...
        const baseY = model.userData.basePos ? model.userData.basePos[1] : -2;
        const floatOffset =
    ...
    const updateCam = () => {
      ...
      if (window.innerWidth < 768) {
        ...
        Object.values(modelsRef.current).forEach((m) => {
          ...
          m.visible = true;
          const originalX = m.userData.id === "egrang" ? -3 : 3;
  ...
  const handlePlay = () => {
    const target =
      activeGameIndex === 0 ? "/Kalimantan/game1" : "/Kalimantan/game2";
          ...
          >
            ...
            <div className="md:w-3/5 p-8 md:p-14 flex flex-col justify-center order-2 md:order-1 pb-20 md:pb-14">
              ...
              <div className="space-y-6 text-[var(--color-foreground)]/80 leading-relaxed mb-10">
                <p className="text-lg">
                  Kalimantan, bagian dari pulau Borneo yang megah, adalah rumah
                  bagi sejarah purba Nusantara. Dari Kerajaan Kutai Martapura
                  hingga tradisi Dayak yang harmonis dengan alam.
                </p>
                ...
                <p className="opacity-70 text-sm">
                  Dikenal dengan sungai-sungainya yang raksasa and hutan hujan
                  khatulistiwa yang menjadi paru-paru dunia. Mari kita pelajari
                  lebih dalam mengenai kekayaan geografi Kalimantan!
                </p>
              </div>
            ...
            <div className="md:w-2/5 bg-gradient-to-br from-[var(--color-primary)]/10 to-[var(--color-accent-gold)]/5 flex items-center justify-center p-8 md:p-12 relative overflow-hidden order-1 md:order-2 border-b md:border-b-0 md:border-l border-[var(--color-accent)]/20">
              ...
              >
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white px-4 py-2 rounded-full shadow-lg border border-[var(--color-accent)]/10 whitespace-nowrap">
                  <span className="text-[var(--color-primary)] font-black text-xs uppercase tracking-[0.4em] ml-[0.4em]">
                    EQUATOR LAND
                  </span>
                </div>
              </motion.div>
          ...
          >
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-45 bottom-64 md:left-[35%] md:top-1/2 md:-translate-y-1/2 md:translate-x-0 md:bottom-auto max-w-md transition-all duration-500 ease-out mb-22">
                  <div className="bg-white/95 backdrop-blur-sm px-5 py-4 rounded-2xl shadow-xl space-y-2">
                    ...
                    <p className="text-sm md:text-base text-[var(--color-foreground)]/80 leading-relaxed text-center md:text-left">
                      Uji keseimbanganmu dalam permainan tradisional egrang
                      bambu yang melatih fokus.
                    </p>
                  </div>
                </div>
              )}
              ...
              {(hoveredGame === "manukan" ||
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-45 bottom-64 md:left-[85%] md:top-1/2 md:-translate-y-1/2 md:translate-x-0 md:bottom-auto max-w-md transition-all duration-500 ease-out mb-22">
                  <div className="bg-white/95 backdrop-blur-sm px-5 py-4 rounded-2xl shadow-xl space-y-2">
                    ...
                    <p className="text-sm md:text-base text-[var(--color-foreground)]/80 leading-relaxed text-center md:text-left">
                      Latih ketajaman memori melalui simbol-simbol ukiran totem
                      Dayak yang unik.
                    </p>
                  </div>
                </div>
            ...
            <div className="md:hidden absolute bottom-8 w-full flex flex-col items-center gap-5 z-20">
              <div className="flex gap-3 mb-1">
                <div
                  className={`h-2.5 rounded-full transition-all duration-300 ${activeGameIndex === 0 ? "w-8 bg-[var(--color-primary)]" : "w-2.5 bg-[var(--color-primary)]/30"}`}
                />
                <div
                  className={`h-2.5 rounded-full transition-all duration-300 ${activeGameIndex === 1 ? "w-8 bg-[var(--color-primary)]" : "w-2.5 bg-[var(--color-primary)]/30"}`}
                />
              </div>
              <button
                onClick={handlePlay}
