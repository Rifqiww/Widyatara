...
const SCALES = [261.63, 293.66, 329.63, 349.23, 392.0, 440.0, 493.88, 523.25]; // C Major
...
export default function AngklungGame() {
  ...
  const spawnNote = (noteIndex: number) => {
    ...
    mesh.position.set(
      startX + noteIndex * CONFIG.laneWidth,
      CONFIG.spawnHeight,
      0,
    );
  ...
  const updateHUD = (points: number, text: string) => {
    ...
    const color =
      points >= 100 ? "#34d399" : points > 0 ? "#facc15" : "#ef4444";
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none flex flex-col justify-between">
        {/* HUD Top */}
        <div
          className="flex flex-col md:flex-row justify-between p-4 md:p-5 text-white"
          style={{
        ...
        >
          <div className="mt-12 md:mt-0">
            <div className="text-[10px] md:text-xs text-amber-200 tracking-widest uppercase">
              Tembang
            </div>
            <div
          ...
          <div className="text-center">
            <div
              className="text-2xl md:text-4xl font-extrabold font-mono text-white"
          ...
          <div className="text-right">
            <div
              ...
              style={{ color: gameState.combo > 0 ? "#facc15" : "#9ca3af" }}
            >
              x{gameState.combo}
            </div>
            <div className="text-[10px] md:text-xs text-gray-400 tracking-widest uppercase text-right">
              Combo
            </div>
          </div>
        </div>
      ...
      {gameState.showMenu && (
        <div
          className="fixed top-0 left-0 w-full h-full flex flex-col pt-14 items-center justify-center pointer-events-auto"
          style={{
            background:
              "linear-gradient(to bottom, rgba(26, 11, 46, 0.75), rgba(20, 10, 5, 0.85))",
        ...
        >
          ...
          <div className="text-center mb-20 relative z-10">
            <h1
              className="text-6xl md:text-9xl font-bold mb-3"
              style={{
                fontFamily: "serif",
                background:
            ...
            <div
              className="text-xl md:text-3xl font-light tracking-[0.5em] md:tracking-[1em] uppercase"
              style={{
            ...
            {[
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-3xl ml-6" style={{ color: "#fbbf24" }}>
                    {song.difficulty}
                  </div>
                </div>
              </button>
      ...
      {gameState.showGameOver && (
        <div
          className="fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center pointer-events-auto"
          style={{
            background:
              "linear-gradient(to bottom, rgba(26, 11, 46, 0.8), rgba(20, 10, 5, 0.9))",
        ...
        >
          <div className="text-center relative z-10">
            <h2
              className="text-6xl font-bold mb-6 text-amber-100"
              style={{
                fontFamily: "serif",
            ...
            <div className="text-2xl text-amber-200/70 mb-4 uppercase tracking-[0.3em]">
              Total Biji
            </div>
            <div
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background =
                    "linear-gradient(135deg, rgba(217, 119, 6, 0.5), rgba(180, 83, 9, 0.5))";
                  e.currentTarget.style.transform = "scale(1.05)";
                  e.currentTarget.style.boxShadow =
